    $.holdReady(true);
    var db = {};
    var d0 = $.getJSON("json/gamedata/ArknightsGameData/zh_CN/gamedata/excel/building_data.json",function(data){
            db["manufactformulas"] = data.manufactFormulas;
        });
    var d1 = $.getJSON("json/gamedata/ArknightsGameData/zh_CN/gamedata/excel/building_data.json",function(data){
            db["workshopformulas"] = data.workshopFormulas;
        });
    var d2 = $.getJSON("json/gamedata/ArknightsGameData/zh_CN/gamedata/excel/character_table.json",function(data){
            db["chars"] = data;
        });
    var d3 = $.getJSON("json/gamedata/ArknightsGameData/zh_CN/gamedata/excel/item_table.json",function(data){
            db["items"] = data.items;
        });
    ...
    var d8 = $.getJSON("json/gamedata/ArknightsGameData/zh_CN/gamedata/excel/gamedata_const.json",function(data){
            db["dataconst"] = data;
        });
    var d9 = $.getJSON("json/gamedata/ArknightsGameData/zh_CN/gamedata/excel/building_data.json",function(data){
            db["building_buff"] = data.buffs;
        });
    var d10 = $.getJSON("json/gamedata/ArknightsGameData/zh_CN/gamedata/excel/building_data.json",function(data){
            ...
            currHtml.push(`<div class="row riicbody" style="">
                            <div class="riic-avatar" style="">
                                <div class="riic-avatar2">
                                    <div ><img class='riic-pic' src="https://raw.githubusercontent.com/PuppiizSunniiz/Arknight-Images/main/avatars/${element.name}.png"></div>
            ...
            // if (charaRiicTL){
                element.buff.forEach((buff, i) => {
                    ...
                    if(buff.cond.phase>0){
                        req += `<img src="https://raw.githubusercontent.com/PuppiizSunniiz/Arknight-Images/main/ui/elite/${buff.cond.phase}.png" style="width:20px;height:20px" title="Elite ${buff.cond.phase}">`
                    }
                    if(req!==""){
                        req = `<div class="riic-req" style="">${req}</div>`
                    }
                    // console.log(req)     
                    var bufficon = `<img src="https://raw.githubusercontent.com/PuppiizSunniiz/Arknight-Images/main/ui/infrastructure/skill/${currBuff2.skillIcon}.png" style="width:40px;height:40px" title="">`
                    currHtml.push(`
                    <div class='riic-tab'>

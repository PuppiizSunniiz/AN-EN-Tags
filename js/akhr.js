...
function init() {
    ...
    var d0 = $.getJSON("json/tl-akhr.json", function (data) {
        ...
        $('.lang[value='+lang+']').addClass('selected');
            ...
            let char_tag_sum = 0;
            // console.log(data);
            var RecruitmentOnly = $("#Rec-Only").hasClass("btn-primary");
            //console.log(RecruitmentOnly)
...
function clickBtnRec(el){
    $(".btn-rec").removeClass("btn-primary btn-secondary").addClass("btn-secondary");
